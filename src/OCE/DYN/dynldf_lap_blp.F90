...
CONTAINS
   ...
   SUBROUTINE dyn_ldf_lap( kt, pub, pvb, pua, pva, kpass )
      ...
      !!----------------------------------------------------------------------
# if defined slave
      integer, external :: slave_lap
      type :: lap_var
         integer   :: jpi, jpj, jpk, fs_two, fs_jpim1, jpjm1, jpkm1, narea
         real(wp)  :: zsign
         integer*8 :: loc_ahmf, loc_e3f_n, loc_r1_e1e2f, loc_e2v, loc_pvb, loc_e1u, loc_pub, &
                      loc_ahmt, loc_e3t_b, loc_r1_e1e2t, loc_e2u, loc_e3u_b, loc_e1v, loc_e3v_b, &
                      loc_pua, loc_pva, loc_r1_e2u, loc_r1_e1u, loc_r1_e1v, loc_r1_e2v, loc_e3u_n, loc_e3v_n
      end type lap_var
      type(lap_var) :: l_v
      l_v%jpi = jpi
      l_v%jpj = jpj
      l_v%jpk = jpk
      l_v%fs_two = fs_2
      l_v%fs_jpim1 = fs_jpim1
      l_v%jpjm1 = jpjm1
      l_v%jpkm1 = jpkm1
      l_v%narea = narea
      l_v%loc_ahmf = loc(ahmf)
      l_v%loc_ahmt = loc(ahmt)
      l_v%loc_e3f_n = loc(e3f_n)
      l_v%loc_e3t_b = loc(e3t_b)
      l_v%loc_r1_e1e2f = loc(r1_e1e2f)
      l_v%loc_r1_e1e2t = loc(r1_e1e2t)
      l_v%loc_e3u_b = loc(e3u_b)
      l_v%loc_e3v_b = loc(e3v_b)
      l_v%loc_pvb = loc(pvb)
      l_v%loc_pub = loc(pub)
      l_v%loc_e2v = loc(e2v)
      l_v%loc_e2u = loc(e2u)
      ...
      l_v%loc_pua = loc(pua)
      l_v%loc_pva = loc(pva)
      l_v%loc_r1_e2u = loc(r1_e2u) 
      l_v%loc_r1_e2v = loc(r1_e2v)
      l_v%loc_r1_e1u = loc(r1_e1u)
      l_v%loc_r1_e1v = loc(r1_e1v)
      l_v%loc_e3u_n = loc(e3u_n)
      l_v%loc_e3v_n = loc(e3v_n)
# endif
      !
...
# endif
      ...
      !                                                ! ===============
# if defined slave
      call athread_spawn(slave_lap, l_v)
      call athread_join()
# else
