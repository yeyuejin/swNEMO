...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: dynkeg.F90 11536 2019-09-11 13:54:18Z smasson $ 
...
CONTAINS
   ...
   SUBROUTINE dyn_keg( kt, kscheme )
      ...
      !!----------------------------------------------------------------------
# if defined slave
      integer, external :: slave_keg
      type :: keg_var
         integer   :: jpi, jpj, jpk, fs_two, fs_jpim1, jpjm1, jpkm1, narea
         integer*8 :: loc_un, loc_vn, loc_ua, loc_va, loc_e1u, loc_e2v
      end type keg_var
      type(keg_var) :: k_v
      k_v%jpi = jpi
      k_v%jpj = jpj
...
# if defined slave
      call athread_spawn(slave_keg, k_v)
      call athread_join()
# else
