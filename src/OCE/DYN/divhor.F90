...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: divhor.F90 12141 2019-12-10 11:43:20Z smasson $ 
...
! yyj -->      
!      real(wp), dimension(jpi,jpj,jpk) :: checktmp
!      real*8::t1,t2,t3,t4,tag

#if defined slave      
      external :: slave_div_hor
      type :: var_div_hor
        integer :: jpi,jpj,jpk
        integer :: jn, jpkm1, jpjm1, fs2, fsjpim1, narea
        integer*8 :: loc_hdivn, loc_e2u, loc_e3u_n, loc_un, loc_e1v, loc_e3v_n, &
                     loc_vn, loc_r1_e1e2t, loc_e3t_n
      endtype
      type(var_div_hor) :: v
...
#if defined slave
!     t1 = mpi_wtime()
     call athread_spawn(slave_div_hor, v)
     call athread_join()
!     t2 = mpi_wtime()
#else      
!      t3 = MPI_wtime()
