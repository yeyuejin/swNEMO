...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: traadv_fct.F90 12055 2019-12-04 16:20:14Z jchanut $
...
CONTAINS
   ...
   SUBROUTINE tra_adv_fct( kt, kit000, cdtype, p2dt, pun, pvn, pwn,       &
      ...
      REAL(wp), DIMENSION(jpi,jpj,jpk)        ::   zwi, zwx, zwy, zwz, ztu, ztv, zltu, zltv, ztw, zzz
      ...
      !TYPE(PTR_3D)     , DIMENSION(11) ::   ptab_ptr    ! pointer array
...
# if defined fct_time
      real(8) :: st, ed
      real(8), dimension(5) :: elapsed
      integer :: print_flag
      common /flag/ print_flag
# endif
# if defined slave
      integer, external :: slave_fct1, slave_fct2, slave_fct3, slave_fct4
      type :: var1
         integer :: jpi, jpj, jpk, fs_two, fs_jpim1, jpjm1, jpkm1, jn, narea
         real(wp) :: p2dt
         integer*8 :: loc_pun, loc_pvn, loc_ptb, loc_zwx, loc_zwy, loc_zwz, loc_pwn, loc_wmask, loc_e3t_n, loc_e3t_a, loc_e3t_b, loc_r1_e1e2t, loc_tmask, loc_pta, loc_zwi, loc_ptn
      end type var1
      type(var1) :: v1
      v1%jpi = jpi
      v1%jpj = jpj
      ...
      v1%loc_zwz = loc(zwz)
      v1%loc_pwn = loc(pwn)
      v1%loc_wmask = loc(wmask)
      v1%loc_e3t_n = loc(e3t_n)
      v1%loc_e3t_a = loc(e3t_a)
      v1%loc_e3t_b = loc(e3t_b)
      v1%loc_r1_e1e2t = loc(r1_e1e2t)
      v1%loc_tmask = loc(tmask)
      v1%loc_pta = loc(pta)
      v1%loc_zwi = loc(zwi)
      v1%loc_ptn = loc(ptn)
# endif
      ...
      !
      !! if(lwp) print *, "jpkm1, jpjm1, fs_jpim1: ", jpkm1, jpjm1, fs_jpim1
      !
      !IF( ll_zAimp ) THEN
      ...
      !END IF
      !
      !if(lwp) print *, 'kjpt: ', kjpt, 'jpkm1: ', jpkm1, 'jpjm1: ', jpjm1, 'fs_jpim1: ', fs_jpim1
...
# endif
# if defined slave
         call athread_spawn(slave_fct1, v1)
         call athread_join()
# else
         DO jk = 1, jpkm1
            DO jj = 1, jpjm1
...
# endif
# if defined slave
         call athread_spawn(slave_fct2, v1)
         call athread_join()
# else
...
# endif
# if defined slave
         call athread_spawn(slave_fct3, v1)
         call athread_join()
# else
            DO jk = 1, jpkm1
               DO jj = 1, jpjm1
...
# endif
# if defined slave
         call athread_spawn(slave_fct4, v1)
         call athread_join()
# else
         DO jk = 1, jpkm1
            DO jj = 2, jpjm1
...
# endif
# if defined fct_time
         if(lwp .and. print_flag>0 .and. kt==2) then
             print_flag = print_flag - 1
             print *, 'fct_time:', elapsed
         endif
# endif
         !
         !IF ( ll_zAimp ) THEN
...
# endif
# if defined slave
      integer, external :: slave_nono1, slave_nono2, slave_nono3
      type :: var2
         integer :: jpi, jpj, jpk, fs_two, fs_jpim1, jpjm1, jpkm1, jn, narea
         real(wp) :: p2dt, zrtrn, zbig
         integer*8 loc_paa, loc_pbb, loc_pcc, loc_paft, loc_zbup, loc_zbdo, loc_zbetup, loc_zbetdo, loc_e1e2t, loc_e3t_n, loc_pbef, loc_tmask
      end type var2
      type(var2) :: v2
      v2%jpi = jpi
      v2%jpj = jpj
      ...
      v2%loc_pbb = loc(pbb)
      v2%loc_pcc = loc(pcc)
      v2%loc_paft = loc(paft)
      v2%loc_zbup = loc(zbup)
      v2%loc_zbdo = loc(zbdo)
      v2%loc_zbetup = loc(zbetup)
      v2%loc_zbetdo = loc(zbetdo)
      v2%loc_e1e2t = loc(e1e2t)
      v2%loc_e3t_n = loc(e3t_n)
      v2%loc_pbef = loc(pbef)
      v2%loc_tmask = loc(tmask)
# endif
      !
      zbig  = 1.e+38_wp
      zrtrn = 1.e-15_wp
...
# endif
# if defined slave
      call athread_spawn(slave_nono1, v2)
      call athread_join()
# else
...
# endif
# if defined slave
      call athread_spawn(slave_nono2, v2)
      call athread_join()
# else
      DO jk = 1, jpkm1
         ikm1 = MAX(jk-1,1)
...
# endif
# if defined slave
      call athread_spawn(slave_nono3, v2)
      call athread_join()
# else
      DO jk = 1, jpkm1
         DO jj = 2, jpjm1
