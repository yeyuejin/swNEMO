...
# endif
# if defined slave
      integer, external :: slave_zdf1, slave_zdf2, slave_zdf3, slave_zdf4
      type :: var4
         integer :: jpi, jpj, jpk, fs_two, fs_jpim1, jpjm1, jpkm1, jn, narea, kt
         real*8 p2dt
         integer*8 loc_pta, loc_e3t_b, loc_ptb, loc_e3t_n, loc_zwi, loc_zwt, loc_tmask, loc_zws, loc_zwd, loc_e3w_n, loc_e3t_a
      end type var4
      type(var4) :: v4
      v4%jpi = jpi
      v4%jpj = jpj
      ...
      v4%p2dt = p2dt
      v4%loc_pta = loc(pta)
      v4%loc_e3t_b = loc(e3t_b)
      v4%loc_ptb = loc(ptb)
      v4%loc_e3t_n = loc(e3t_n)
      v4%loc_zwi = loc(zwi)
      v4%loc_zwt = loc(zwt)
      v4%loc_tmask = loc(tmask)
      v4%loc_zws = loc(zws)
      v4%loc_zwd = loc(zwd)
      v4%loc_e3w_n = loc(e3w_n)
      v4%loc_e3t_a = loc(e3t_a)
# endif
      !
      !                                               ! ============= !
...
# endif
# if defined slave
         call athread_spawn(slave_zdf1, v4)
         call athread_join()
# else
               DO jk = 1, jpkm1
                  DO jj = 2, jpjm1
...
# endif
# if defined slave
         call athread_spawn(slave_zdf2, v4)
         call athread_join()
# else
...
# endif
# if defined slave
         call athread_spawn(slave_zdf3, v4)
         call athread_join()
# else
...
# endif
# if defined slave
         call athread_spawn(slave_zdf4, v4)
         call athread_join()
# else
