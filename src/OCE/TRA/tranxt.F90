...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: tranxt.F90 12366 2020-02-11 11:17:24Z jchanut $
...
CONTAINS
   ...
   SUBROUTINE tra_nxt_fix( kt, kit000, cdtype, ptb, ptn, pta, kjpt )
...
#if defined slave  
      type :: var_nxt_fix
        integer :: jpi,jpj,jpk,kjpt
        integer :: jn, jpkm1, jpjm1, fs2, fsjpim1, narea
        real(wp) :: ztn, atfp
        integer*8 :: loc_ptn, loc_pta, loc_ptb
      endtype
      type(var_nxt_fix) :: v
      external :: slave_nxt_fix
      ...
      !
#if defined slave
			call athread_spawn(slave_nxt_fix, v)
			call athread_join()
#else      
      DO jn = 1, kjpt
         !
